    ...
    <div className="p-6 space-y-6">
      <div className="flex items-start justify-between gap-6">
        ...
        <div className="flex gap-2">
          <button className="px-3 py-2 rounded-lg bg-[var(--color-primary)] text-white">Edit</button>
          <button className="px-3 py-2 rounded-lg bg-red-600 text-white">Suspend</button>
